...
public class ServiceSpecTest extends BaseServiceSpecTest {
    ...
    public static void beforeAll() {
        ...
        ENV_VARS.set("COUCHBASE_COUNT", "2");
        ENV_VARS.set("COUCHBASE_CPUS", "0.1");
        ENV_VARS.set("COUCHBASE_MEM", "512");
        ENV_VARS.set("COUCHBASE_DISK", "5000");
    ...
    public void testYmlBase() throws Exception {
        // fuck this test testYaml("svc.yml");
    }
}
